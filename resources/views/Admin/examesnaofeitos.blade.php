...
@section('content')
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li><a href="{{url('turmas')}}" class="active"><svg class="glyph stroked app window with content"><use xlink:href="#stroked-app-window-with-content"/></svg> Turmas</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Não feitos</li>
            </ol>
        </div><!--/.row-->

        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Lista dos Exames</h1>
            </div>
        </div><!--/.row-->
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                            <thead>
                            <tr>
                                <th data-sortable="true">ID</th>
                                <th data-sortable="true">Nome</th>
                                <th data-sortable="true">Data</th>
                                <th data-sortable="true">Tipo de Exame</th>
                                <th data-sortable="true">Criado em</th>
                                <th data-sortable="true">Modificado em</th>
                                <th data-sortable="true">Ações</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($tiposDeExamesNaoFeitos as $tipoDeExamesNaoFeito)
                                @foreach($tipoDeExamesNaoFeito->exames as $exame)
                                    <tr>
                                        <td>{{$exame->id}}</td>
                                        <td>{{$exame->nome}}</td>
                                        <td>{{$exame->data}}</td>
                                        <td>{{$tipoDeExamesNaoFeito->nome}}</td>
